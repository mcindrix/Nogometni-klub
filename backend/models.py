...
class Igrac(Base):
    ...
    Prezime: Mapped[str] = mapped_column(String(100))
    DatumRodjenja: Mapped[date | None] = mapped_column(nullable=True)
    PozicijaID: Mapped[int] = mapped_column(ForeignKey("pozicije.PozicijaID", ondelete="RESTRICT"), nullable=False)
    EkipaID: Mapped[int | None] = mapped_column(ForeignKey("ekipe.EkipaID", ondelete="RESTRICT"), nullable=True)
...
class Clanarina(Base):
    ...
    IgracID: Mapped[int] = mapped_column(ForeignKey("igraci.IgracID", ondelete="RESTRICT"), nullable=False)
    Iznos: Mapped[float]
...
class Utakmica(Base):
    ...
    EkipaID: Mapped[int] = mapped_column(ForeignKey("ekipe.EkipaID", ondelete="RESTRICT"), nullable=False)
    Protivnik: Mapped[str] = mapped_column(String(150))
    StadionID: Mapped[int] = mapped_column(ForeignKey("stadioni.StadionID", ondelete="RESTRICT"), nullable=False)
...
class Trening(Base):
    ...
    EkipaID: Mapped[int] = mapped_column(ForeignKey("ekipe.EkipaID", ondelete="RESTRICT"), nullable=False)
    TrenerID: Mapped[int] = mapped_column(ForeignKey("treneri.TrenerID", ondelete="RESTRICT"), nullable=False)
    StadionID: Mapped[int | None] = mapped_column(ForeignKey("stadioni.StadionID", ondelete="RESTRICT"), nullable=True)
    DatumVrijeme: Mapped[datetime]
...
class Korisnik(Base):
    ...
    TrenerID: Mapped[int | None] = mapped_column(ForeignKey("treneri.TrenerID", ondelete="SET NULL"), nullable=True)
    IgracID: Mapped[int | None] = mapped_column(ForeignKey("igraci.IgracID", ondelete="SET NULL"), nullable=True)
